...
export class _3BandEQ extends Effect<_3BandEQOptions> {
  ...
  constructor(_context: AudioContext, options: _3BandEQOptions = {}) {
    ...
    this._midFilterChannel = new ChannelStrip(this._context, [this._midLowFilterNode, this._midHighFilterNode]);
  ...
  setMidHighFrequencyBreakpoint(value: number) {
    ...
    this._midHighFilterNode.frequency.value = (this.options.breakPoints.lowMid + this.options.breakPoints.midHigh) / 2;

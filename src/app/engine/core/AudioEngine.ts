...
export class AudioEngine {
  ...
  // async getAduioInputSources(): Promise<InputDeviceInfo> {
  async getAduioInputSources(): Promise<any> {
    // return new window.InputDeviceInfo();
    return new (window.navigator as any).InputDeviceInfo();
  }
  ...
  // ): SoundPlayer;
  createSoundPlayer(playerName: string, sounds: SoundFilesLibrary, channelName: string = 'master'): SoundPlayer {
